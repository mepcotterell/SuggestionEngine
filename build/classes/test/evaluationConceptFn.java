 ...
 * @author mepcotterell
 */
public class evaluationConceptFn {
    ...
    public static void main (String[] args) {
        ...
        System.out.println();
        System.out.println("---------------------evaluationConceptFn-----------------------------");
        ...
        desiredOps = "http://purl.obolibrary.org/obo/obi.owl#Class_75";//
        ...
        desiredOps = "http://purl.obolibrary.org/obo/webService.owl#Class_0009";//http://purl.obolibrary.org/obo/webService.owl#Class_011"; 
        suggestOpList2 = sugg2.suggestNextService(workflowOpsOBI, candidateOpsOBI, desiredOps, ontology, null);        
        System.out.println();
        ...
        desiredOps = "http://purl.obolibrary.org/obo/obi.owl#Class_72";
        suggestOpList2 = sugg2.suggestNextService(workflowOpsOBI, candidateOpsOBI, desiredOps, ontology, null);        
        System.out.println();
        ...
        desiredOps = "http://purl.obolibrary.org/obo/obi.owl#Class_73";
        suggestOpList2 = sugg2.suggestNextService(workflowOpsOBI, candidateOpsOBI, desiredOps, ontology, null);        
        System.out.println();
