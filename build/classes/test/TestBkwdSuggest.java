...
public class TestBkwdSuggest {
    ...
    public static void main (String[] args) {
       ...
       candidateOpsOBI.add(new WebServiceOpr("getParameterDetails", muscle));
        ...
        List<WebServiceOprScore> suggestOpList2 = sugg2.suggestPrevServices(workflowOpsOBI, candidateOpsOBI, desiredOps, ontology, null);
                    System.out.println("\n");
        for (WebServiceOprScore suggestion: suggestOpList2) {
            ...
            System.out.println();
            List<MatchedIOPaths.PathMatches> mps = suggestion.getMatchedPathsOp().getMatchedPaths();
