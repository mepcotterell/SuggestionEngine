...
public class evaluationWoAnn {
    ...
    public static String wsconverter = "http://mango.ctegd.uga.edu/jkissingLab/SWS/Wsannotation/resources/WSConverter.wsdl";
    ...
    public static String filterSeq= "http://mango.ctegd.uga.edu/jkissingLab/SWS/Wsannotation/resources/FilterSequencesWS.wsdl";
    public static String phylip= "http://mango.ctegd.uga.edu/jkissingLab/SWS/Wsannotation/resources/phylip.wsdl";
    ...
    public static void main (String[] args) {
        ...
        System.out.println();
        System.out.println("--------------------evaluationWoAnn------------------------------");
        ...
        workflowOpsOBI.add(new WebServiceOpr("PhylipProtdist", phylip));
        desiredOps = "";
        suggestOpList2 = sugg2.suggestNextService(workflowOpsOBI, candidateOpsOBI, desiredOps, ontology, null);        
        System.out.println();
